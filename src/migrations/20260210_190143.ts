...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('super-admin', 'admin', 'organizer', 'viewer');
  CREATE TYPE "public"."enum_users_tenant_memberships_role" AS ENUM('admin', 'organizer', 'viewer');
  CREATE TYPE "public"."enum_tenants_nav_items_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE "users_tenant_memberships" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tenant_id" integer,
  	"role" "enum_users_tenant_memberships_role" DEFAULT 'organizer'
  );
  ...
  CREATE TABLE "tenants_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_tenants_nav_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  ...
  CREATE TABLE "tenants" (
  	...
  	"branding_cover_id" integer,
  	"branding_colors_primary" varchar,
  	"branding_colors_accent" varchar,
  	"branding_social_instagram" varchar,
  	"branding_social_facebook" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "tenants_nav_items" ADD CONSTRAINT "tenants_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "tenants" ADD CONSTRAINT "tenants_branding_cover_id_media_id_fk" FOREIGN KEY ("branding_cover_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "tenants_rels" ADD CONSTRAINT "tenants_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "tenants_rels" ADD CONSTRAINT "tenants_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "tenants_nav_items_order_idx" ON "tenants_nav_items" USING btree ("_order");
  CREATE INDEX "tenants_nav_items_parent_id_idx" ON "tenants_nav_items" USING btree ("_parent_id");
  CREATE INDEX "tenants_branding_branding_logo_idx" ON "tenants" USING btree ("branding_logo_id");
  CREATE INDEX "tenants_branding_branding_cover_idx" ON "tenants" USING btree ("branding_cover_id");
  ...
  CREATE INDEX "tenants_rels_pages_id_idx" ON "tenants_rels" USING btree ("pages_id");
  CREATE INDEX "tenants_rels_posts_id_idx" ON "tenants_rels" USING btree ("posts_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "tenants_nav_items" CASCADE;
  ...
  DROP TYPE "public"."enum_tenants_nav_items_link_type";
